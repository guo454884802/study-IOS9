...
class DoubleComponentPickerViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    private let fillingType = ["Ham","Turkey","Peanut Butter","Tuna Salad","Chicken Salad","Roast Beef","Vegemite"]
    private let breadType = ["White","Whole Wheat","Rye","Sourdough","Seven Grain"]
    ...
    @IBAction func buttonPressed(sender: UIButton) {
        ...
        let message = "你的\(filling)\(bread)面包将好了"
        let alert = UIAlertController(title: "谢谢你的菜单", message: message, preferredStyle: .Alert)
